                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Driver’s Commission</h3>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">₱{{ number_format($total, 2) }} × 20%</p>
                                    </div>
                                    <div class="text-right">
                                        <span class="text-3xl font-bold text-green-600 dark:text-green-400">₱{{
                                            number_format($drivercut, 2) }}</span>
                                    </div>
