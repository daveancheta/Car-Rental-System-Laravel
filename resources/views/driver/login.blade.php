...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center font-sans">
    ...
    <div
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Driver Login</p>
        </div>

        <form class="space-y-5" method="POST" action="/loginasdriver">
            @csrf
        ...
        <a href="/registerasdriver">Dont have an account yet? Sign Up Now.</a>
    </div>
