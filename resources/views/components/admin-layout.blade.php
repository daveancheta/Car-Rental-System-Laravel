...
<body class="bg-gray-100 dark:bg-gray-900"
   style="font-family: 'Inter', sans-serif; scrollbar-width: thin; scrollbar-color: #6b7280 transparent;">
         ...
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <a href="/display-rented"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap">Rented</span>
               </a>
            </li>
            <li>
               <a href="#"
            ...
            <li>
               <a href="/create"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap">Crud</span>
               </a>
            </li>
            <li>
               <button type="submit" form="logout-form"
                  class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group text-start cursor-pointer">
                  <svg
                     class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
   ...
   <form action="/logoutasadmin" method="POST" id="logout-form">
      @csrf
   </form>
